...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Mthhx"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Mthhx"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
	  OrionLib:MakeNotification({Name = "Mthhx -",Content = "HUB sendo apagado, dados não deletados." ,Image = "rbxassetid://",Time = 7})task.wait(1)
	  Orion:Destroy()
	end)

	OrionLib:MakeNotification({Name = "Mthhx -",Content = "HUB sendo Iniciado |" ,Image = "rbxassetid://14824506141",Time = 7})
